<div class="col ">
    <div class="container-fluid w-50">
        <form action="">
            ...
            <p>Da der Login Vorgang technisch noch nicht realisiert wurde: <a href= <?php echo base_url('/aktuellesProjekt') ?> class="link-primary text-decoration-none">Überspringen</a></p>
        </form>
    </div>
</div>
